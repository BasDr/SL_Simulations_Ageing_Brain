...
def top_10_mean_corr():
    ...
    # Save the workbook
    workbook.save("graphs_mean/1_to_70/Mean_analyses_formatted_error.xlsx")
...
def top_10_mean_corr_all():
    ...
    # Save the workbook
    workbook.save("graphs_mean/1_to_70/Mean_analyses_formatted_XXL.xlsx")
...
def plot_psd(max_freq=250):
    filepath = f'simulation_results/signal_C13.97_md6_a-4.00_dt0.1.npy'
